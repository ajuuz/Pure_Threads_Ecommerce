...
const SalesReport = () => {
  ...
  const handleGenerateReport=async()=>{
    ...
    try{
      ...
      setBestSellingProducts(salesReport?.bestSellingProducts)
      setBestSellingCategories(salesReport.bestSellingCategories)
              ...
              <div className='grid grid-cols-2'>
                <div className='border py-5'>
                  ...
                  <div className='flex flex-col gap-3'>
                    {bestSellingProducts.map((product)=><p>{product?.productName} <Badge>sold Count:{product?.soldCount}</Badge></p>)}
                  </div>
                </div>
                <div className='border py-5'>
                  <h4 className='mb-3 font-semibold'>Category</h4>
                  <div className='flex flex-col gap-3'>
                    {bestSellingCategories.map((category)=><p>{category?.categoryName} <Badge>sold Count:{category?.soldCount}</Badge></p>)}
                  </div>
                </div>
              </div>
              </CardHeader>
